...
clean:
	rm -f v1495-registers v1495-counters cfd-registers v1495-counters-database v1495-registers.o v1495-counters.o cfd-registers.o v1495-counters-database.o common.o counters.hpp
